        ...
        return <div>
            <form onSubmit = {(e) => {
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" value = {this.state.severityDeviation} onChange = {(e) => {severityDeviation = e.target.value}} aria-describedby="emailHelp" placeholder="Enter deviation for accident severity" />
                </div>
                <div class="form-group">
                    <label>Deviation of Rain</label>
                    <input class="form-control" value = {this.state.rainDeviation} onChange = {(e) => {rainDeviation = e.target.value}} placeholder='Enter Deviation for amount rain' />
                </div>
                <div class="form-group form-check">
                    <input type="checkbox" class="form-check-input" id="exampleCheck1" />
                    <label class="form-check-label" for="exampleCheck1">Verify values</label>
                </div>
